            ...
            <main className="flex-1 overflow-y-auto p-4 lg:p-8 pb-24 lg:pb-8 scroll-smooth relative" id="main-content">
                {isLoading && !data.categories.all.length ? (
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        {view === 'investments' && <Investments data={data} onAdd={(d)=>handleInvestment('add',null,d)} onUpdate={(id,d)=>handleInvestment('update',id,d)} onDelete={(id)=>confirmAction('ইনভেস্টমেন্ট মুছুন', 'নিশ্চিত?', ()=>handleInvestment('delete',id))} />}
